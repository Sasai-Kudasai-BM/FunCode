...
public final class VkNvShadingRateImage {
	...
	private static final MethodHandle vkCmdBindShadingRateImageNV = createHandle("vkCmdBindShadingRateImageNV", VOID, LONG, LONG, INT);

	@NativeType("void")
	public static void vkCmdBindShadingRateImageNV(@NativeType("VkCommandBuffer*") /*external sync*/ long commandBuffer, @NativeType("VkImageView*") /*optional*/ long imageView, @NativeType("VkImageLayout") int imageLayout) {
		try {
			vkCmdBindShadingRateImageNV.invokeExact(commandBuffer, imageView, imageLayout);
		} catch (Throwable e) { throw new RuntimeException(e); }
	}

	private static final MethodHandle vkCmdSetViewportShadingRatePaletteNV = createHandle("vkCmdSetViewportShadingRatePaletteNV", VOID, LONG, INT, INT, LONG);

	@NativeType("void")
	public static void vkCmdSetViewportShadingRatePaletteNV(@NativeType("VkCommandBuffer*") /*external sync*/ long commandBuffer, @NativeType("uint32_t") int firstViewport, @NativeType("uint32_t") int viewportCount, @NativeType("VkShadingRatePaletteNV*") long pShadingRatePalettes) {
		try {
			vkCmdSetViewportShadingRatePaletteNV.invokeExact(commandBuffer, firstViewport, viewportCount, pShadingRatePalettes);
		} catch (Throwable e) { throw new RuntimeException(e); }
	}

	private static final MethodHandle vkCmdSetCoarseSampleOrderNV = createHandle("vkCmdSetCoarseSampleOrderNV", VOID, LONG, INT, INT, LONG);

	@NativeType("void")
	public static void vkCmdSetCoarseSampleOrderNV(@NativeType("VkCommandBuffer*") /*external sync*/ long commandBuffer, @NativeType("VkCoarseSampleOrderTypeNV") int sampleOrderType, @NativeType("uint32_t") /*optional*/ int customSampleOrderCount, @NativeType("VkCoarseSampleOrderCustomNV*") long pCustomSampleOrders) {
		try {
