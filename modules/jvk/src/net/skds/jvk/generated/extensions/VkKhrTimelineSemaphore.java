...
public final class VkKhrTimelineSemaphore {
	...
	public static final int VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES_KHR = 0;

	public static final int VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES_KHR = 1;

	public static final int VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO_KHR = 2;

	public static final int VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO_KHR = 3;

	public static final int VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO_KHR = 4;

	public static final int VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO_KHR = 5;
	...
	private static final MethodHandle vkGetSemaphoreCounterValueKHR = createHandle("vkGetSemaphoreCounterValueKHR", INT, LONG, LONG, LONG);
	...
	*/
	...
	private static final MethodHandle vkWaitSemaphoresKHR = createHandle("vkWaitSemaphoresKHR", INT, LONG, LONG, LONG);
	...
	*/
	...
	private static final MethodHandle vkSignalSemaphoreKHR = createHandle("vkSignalSemaphoreKHR", INT, LONG, LONG);
