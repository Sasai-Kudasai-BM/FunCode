...
public final class VkExtExternalMemoryHost {
	...
	**/
	@NativeType("VkResult")
	public static int vkGetMemoryHostPointerPropertiesEXT(@NativeType("VkDevice*") long device, @NativeType("VkExternalMemoryHandleTypeFlagBits") int handleType, /* optional */ @NativeType("void*") long pHostPointer, @NativeType("VkMemoryHostPointerPropertiesEXT*") long pMemoryHostPointerProperties) {
		try {
