...
public final class VkExtSwapchainMaintenance1 {
	...
	private static final MethodHandle vkReleaseSwapchainImagesEXT = createHandle(VkDefinitions.LIBRARY_LOOKUP, "vkReleaseSwapchainImagesEXT", INT, LONG, LONG);
	...
	**/
	@NativeType("VkResult")
	public static int vkReleaseSwapchainImagesEXT(@NativeType("VkDevice*") long device, @NativeType("VkReleaseSwapchainImagesInfoKHR*") long pReleaseInfo) {
		try {
			return (int) vkReleaseSwapchainImagesEXT.invokeExact(device, pReleaseInfo);
		} catch (Throwable e) {
			throw new Error(e);
		}
	}
