...
public final class VkExtDebugMarker {
	...
	**/
	@NativeType("VkResult")
	public static int vkDebugMarkerSetObjectTagEXT(@NativeType("VkDevice*") long device, /* external sync */ @NativeType("VkDebugMarkerObjectTagInfoEXT*") long pTagInfo) {
		try {
	...
	**/
	@NativeType("VkResult")
	public static int vkDebugMarkerSetObjectNameEXT(@NativeType("VkDevice*") long device, /* external sync */ @NativeType("VkDebugMarkerObjectNameInfoEXT*") long pNameInfo) {
		try {
