...
public final class VkKhrXcbSurface {
	...
	**/
	...
	@NativeType("VkBool32")
	public static boolean vkGetPhysicalDeviceXcbPresentationSupportKHR(@NativeType("VkPhysicalDevice*") long physicalDevice, @NativeType("uint32_t") int queueFamilyIndex, @NativeType("xcb_connection_t**") long connection, @NativeType("xcb_visualid_t*") long visual_id) {
		try {
			return (int) vkGetPhysicalDeviceXcbPresentationSupportKHR.invokeExact(physicalDevice, queueFamilyIndex, connection, visual_id) != 0;
		} catch (Throwable e) {
			throw new Error(e);
		}
	}
