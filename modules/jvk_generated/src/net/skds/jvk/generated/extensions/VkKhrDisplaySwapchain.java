...
public final class VkKhrDisplaySwapchain {
	...
	**/
	@NativeType("VkResult")
	public static int vkCreateSharedSwapchainsKHR(@NativeType("VkDevice*") long device, @NativeType("uint32_t") int swapchainCount, /* external sync */ @NativeType("VkSwapchainCreateInfoKHR*") long pCreateInfos, /* optional */ @NativeType("VkAllocationCallbacks*") long pAllocator, @NativeType("VkSwapchainKHR**") long pSwapchains) {
		try {
