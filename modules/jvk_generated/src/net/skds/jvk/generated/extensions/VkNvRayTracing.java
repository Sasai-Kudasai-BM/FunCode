...
public final class VkNvRayTracing {
	...
	**/
	@NativeType("VkResult")
	public static int vkCreateRayTracingPipelinesNV(@NativeType("VkDevice*") long device, /* optional */ @NativeType("VkPipelineCache*") long pipelineCache, @NativeType("uint32_t") int createInfoCount, @NativeType("VkRayTracingPipelineCreateInfoNV*") long pCreateInfos, /* optional */ @NativeType("VkAllocationCallbacks*") long pAllocator, @NativeType("VkPipeline**") long pPipelines) {
		try {
