...
public final class VkKhrSwapchain {
	...
	**/
	@NativeType("VkResult")
	public static int vkCreateSwapchainKHR(@NativeType("VkDevice*") long device, /* external sync */ @NativeType("VkSwapchainCreateInfoKHR*") long pCreateInfo, /* optional */ @NativeType("VkAllocationCallbacks*") long pAllocator, @NativeType("VkSwapchainKHR**") long pSwapchain) {
		try {
	...
	**/
	@NativeType("VkResult")
	public static int vkQueuePresentKHR(/* external sync */ @NativeType("VkQueue*") long queue, /* external sync */ @NativeType("VkPresentInfoKHR*") long pPresentInfo) {
		try {
