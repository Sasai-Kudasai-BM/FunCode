...
public final class VkLayerProperties extends CStruct {
	...
	public byte layerName(int i) {
		return (byte) BYTE_HANDLE.get(this.segment, this.offset + LAYER_NAME_OFFSET + JAVA_BYTE.byteSize() * i);
	}
	
	@NativeType("char[256]")
	public byte[] layerNameArray() {
		var array = new byte[256];
		MemorySegment.copy(this.segment, BYTE, this.offset + LAYER_NAME_OFFSET, array, 0, array.length);
		return array;
	}
	
	@NativeType("char[256]")
	public String layerName() {
		return this.segment.getString(this.offset + LAYER_NAME_OFFSET);
	}
	
	@NativeType("char[256]")
	public VkLayerProperties layerName(int i, byte value) {
		BYTE_HANDLE.set(this.segment, this.offset + LAYER_NAME_OFFSET + JAVA_BYTE.byteSize() * i, value);
		return this;
	}
	
	@NativeType("char[256]")
	public VkLayerProperties layerName(byte[] value) {
		MemorySegment.copy(value, 0, this.segment, BYTE, this.offset + LAYER_NAME_OFFSET, value.length);
		return this;
	}
	
	@NativeType("char[256]")
	public VkLayerProperties layerName(String value) {
		this.segment.setString(this.offset + LAYER_NAME_OFFSET, value);
		return this;
	}
	...
	@NativeType("char[256]")
	public VkLayerProperties description(byte[] value) {
		MemorySegment.copy(value, 0, this.segment, BYTE, this.offset + DESCRIPTION_OFFSET, value.length);
		return this;
	}
	
	@NativeType("char[256]")
	public VkLayerProperties description(String value) {
	...
	public static final class Array extends VkStructArray<VkLayerProperties> {
		...
		private static final StructConstructor<VkLayerProperties> CONSTRUCTOR = VkLayerProperties::new;
