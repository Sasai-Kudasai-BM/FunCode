...
**/
@AutoGenerated
public final class VkBufferCopy2KHR extends CStruct {
	...
	public VkBufferCopy2KHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkBufferCopy2KHR(MemorySegment segment, long offset) {
	...
	public VkBufferCopy2KHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000337006);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkBufferCopy2KHR> {
		
		private static final StructConstructor<VkBufferCopy2KHR> CONSTRUCTOR = VkBufferCopy2KHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkBufferCopy2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkBufferCopy2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkBufferCopy2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
