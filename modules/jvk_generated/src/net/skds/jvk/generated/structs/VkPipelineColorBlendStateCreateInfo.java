...
public final class VkPipelineColorBlendStateCreateInfo extends CStruct {
	...
	public VkPipelineColorBlendStateCreateInfo sType$Default() {
		INT_HANDLE.get(this.segment, this.offset + S_TYPE_OFFSET, 26);
		return this;
	}
	...
	public int logicOpEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + LOGIC_OP_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineColorBlendStateCreateInfo logicOpEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + LOGIC_OP_ENABLE_OFFSET, value);
		return this;
	}
	...
	public float blendConstants(int i) {
		return (float) FLOAT_HANDLE.get(this.segment, this.offset + BLEND_CONSTANTS_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i);
	}
	
	@NativeType("float[4]")
	public VkPipelineColorBlendStateCreateInfo blendConstants(int i, float value) {
		FLOAT_HANDLE.set(this.segment, this.offset + BLEND_CONSTANTS_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i, value);
		return this;
	}
