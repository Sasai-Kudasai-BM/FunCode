...
**/
@AutoGenerated
public final class VkAccelerationStructureInstanceNV extends CStruct {
	...
	public VkAccelerationStructureInstanceNV(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkAccelerationStructureInstanceNV(MemorySegment segment, long offset) {
	...
	@NativeType("uint32_t")
	public VkAccelerationStructureInstanceNV instanceCustomIndex(int value) {
	...
	@NativeType("uint32_t")
	public VkAccelerationStructureInstanceNV mask(int value) {
	...
	@NativeType("uint32_t")
	public VkAccelerationStructureInstanceNV instanceShaderBindingTableRecordOffset(int value) {
	...
	/** optional **/
	@NativeType("VkGeometryInstanceFlagsKHR")
	public VkAccelerationStructureInstanceNV flags(int value) {
	...
	@NativeType("uint64_t")
	public VkAccelerationStructureInstanceNV accelerationStructureReference(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkAccelerationStructureInstanceNV> {
		
		private static final StructConstructor<VkAccelerationStructureInstanceNV> CONSTRUCTOR = VkAccelerationStructureInstanceNV::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkAccelerationStructureInstanceNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkAccelerationStructureInstanceNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkAccelerationStructureInstanceNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
