...
**/
@AutoGenerated
public final class VkMemoryMapInfoKHR extends CStruct {
	...
	public VkMemoryMapInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkMemoryMapInfoKHR(MemorySegment segment, long offset) {
	...
	public VkMemoryMapInfoKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000271000);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkMemoryMapInfoKHR> {
		
		private static final StructConstructor<VkMemoryMapInfoKHR> CONSTRUCTOR = VkMemoryMapInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkMemoryMapInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkMemoryMapInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkMemoryMapInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
