...
public final class VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR extends CStruct {
	...
	public int rayTracingMaintenance1() {
		return (int) INT_HANDLE.get(this.segment, this.offset + RAY_TRACING_MAINTENANCE1_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR rayTracingMaintenance1(int value) {
		INT_HANDLE.set(this.segment, this.offset + RAY_TRACING_MAINTENANCE1_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int rayTracingPipelineTraceRaysIndirect2() {
		return (int) INT_HANDLE.get(this.segment, this.offset + RAY_TRACING_PIPELINE_TRACE_RAYS_INDIRECT2_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR rayTracingPipelineTraceRaysIndirect2(int value) {
		INT_HANDLE.set(this.segment, this.offset + RAY_TRACING_PIPELINE_TRACE_RAYS_INDIRECT2_OFFSET, value);
		return this;
	}
