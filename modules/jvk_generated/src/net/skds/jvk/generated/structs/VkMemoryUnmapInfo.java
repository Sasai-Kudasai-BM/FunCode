...
**/
@AutoGenerated
public final class VkMemoryUnmapInfo extends CStruct {
	...
	public VkMemoryUnmapInfo(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkMemoryUnmapInfo(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkMemoryUnmapInfo> {
		
		private static final StructConstructor<VkMemoryUnmapInfo> CONSTRUCTOR = VkMemoryUnmapInfo::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkMemoryUnmapInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkMemoryUnmapInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkMemoryUnmapInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
