...
**/
@AutoGenerated
public final class VkPhysicalDeviceMaintenance5Properties extends CStruct {
	...
	public VkPhysicalDeviceMaintenance5Properties(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceMaintenance5Properties(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceMaintenance5Properties sType(int value) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceMaintenance5Properties sType$Default() {
	...
	/** optional **/
	@NativeType("void*")
	public VkPhysicalDeviceMaintenance5Properties pNext(long value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceMaintenance5Properties earlyFragmentMultisampleCoverageAfterSampleCounting(boolean value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceMaintenance5Properties earlyFragmentSampleMaskTestBeforeSampleCounting(boolean value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceMaintenance5Properties depthStencilSwizzleOneSupport(boolean value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceMaintenance5Properties polygonModePointSize(boolean value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceMaintenance5Properties nonStrictSinglePixelWideLinesUseParallelogram(boolean value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceMaintenance5Properties nonStrictWideLinesUseParallelogram(boolean value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceMaintenance5Properties> {
		
		private static final StructConstructor<VkPhysicalDeviceMaintenance5Properties> CONSTRUCTOR = VkPhysicalDeviceMaintenance5Properties::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceMaintenance5Properties[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceMaintenance5Properties[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceMaintenance5Properties[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
