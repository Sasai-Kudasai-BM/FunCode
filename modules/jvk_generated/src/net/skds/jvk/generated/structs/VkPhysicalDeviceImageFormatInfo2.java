...
**/
@AutoGenerated
public final class VkPhysicalDeviceImageFormatInfo2 extends CStruct {
	...
	public VkPhysicalDeviceImageFormatInfo2(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceImageFormatInfo2(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2 **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceImageFormatInfo2 sType$Default() {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceImageFormatInfo2> {
		
		private static final StructConstructor<VkPhysicalDeviceImageFormatInfo2> CONSTRUCTOR = VkPhysicalDeviceImageFormatInfo2::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceImageFormatInfo2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceImageFormatInfo2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceImageFormatInfo2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
