...
public final class VkNativeBufferANDROID extends CStruct {
	...
	private static final int USAGE2_OFFSET = 32;
	...
	public VkNativeBufferANDROID sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000010000);
		return this;
	}
	...
	public static final class Array extends VkStructArray<VkNativeBufferANDROID> {
		...
		private static final StructConstructor<VkNativeBufferANDROID> CONSTRUCTOR = VkNativeBufferANDROID::new;
