...
**/
@AutoGenerated
public final class VkConformanceVersion extends CStruct {
	...
	public VkConformanceVersion(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkConformanceVersion(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkConformanceVersion> {
		
		private static final StructConstructor<VkConformanceVersion> CONSTRUCTOR = VkConformanceVersion::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkConformanceVersion[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkConformanceVersion[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkConformanceVersion[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
