...
public final class VkVideoSessionCreateInfoKHR extends CStruct {
	...
	private static final int REFERENCE_PICTURES_FORMAT_OFFSET = 44;
	private static final int MAX_REFERENCE_PICTURES_SLOTS_COUNT_OFFSET = 48;
	private static final int MAX_REFERENCE_PICTURES_ACTIVE_COUNT_OFFSET = 52;
	...
	public int referencePicturesFormat() {
		return (int) INT_HANDLE.get(this.segment, this.offset + REFERENCE_PICTURES_FORMAT_OFFSET);
	}
	
	@NativeType("VkFormat")
	public VkVideoSessionCreateInfoKHR referencePicturesFormat(int value) {
		INT_HANDLE.set(this.segment, this.offset + REFERENCE_PICTURES_FORMAT_OFFSET, value);
		return this;
	}
	...
	@NativeType("uint32_t")
	public VkVideoSessionCreateInfoKHR maxReferencePicturesSlotsCount(int value) {
	...
	@NativeType("uint32_t")
	public VkVideoSessionCreateInfoKHR maxReferencePicturesActiveCount(int value) {
