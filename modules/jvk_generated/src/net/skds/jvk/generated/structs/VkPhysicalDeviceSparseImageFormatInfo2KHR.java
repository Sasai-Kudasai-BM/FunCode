...
public final class VkPhysicalDeviceSparseImageFormatInfo2KHR extends CStruct {
	...
	private static final int TILING_OFFSET = 32;
	
	public VkPhysicalDeviceSparseImageFormatInfo2KHR() {
		this.segment = Arena.ofAuto().allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceSparseImageFormatInfo2KHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceSparseImageFormatInfo2KHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2 **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceSparseImageFormatInfo2KHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000059008);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceSparseImageFormatInfo2KHR> {
		
		private static final StructConstructor<VkPhysicalDeviceSparseImageFormatInfo2KHR> CONSTRUCTOR = VkPhysicalDeviceSparseImageFormatInfo2KHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceSparseImageFormatInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceSparseImageFormatInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceSparseImageFormatInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
