...
public final class VkRenderingAttachmentInfoKHR extends CStruct {
	...
	public VkRenderingAttachmentInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkRenderingAttachmentInfoKHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO **/
	@NativeType("VkStructureType")
	public VkRenderingAttachmentInfoKHR sType(int value) {
	...
	/** optional **/
	@NativeType("void*")
	public VkRenderingAttachmentInfoKHR pNext(long value) {
	...
	/** optional **/
	@NativeType("VkImageView*")
	public VkRenderingAttachmentInfoKHR imageView(long value) {
	...
	@NativeType("VkImageLayout")
	public VkRenderingAttachmentInfoKHR imageLayout(int value) {
	...
	/** optional **/
	@NativeType("VkResolveModeFlagBits")
	public VkRenderingAttachmentInfoKHR resolveMode(int value) {
	...
	/** optional **/
	@NativeType("VkImageView*")
	public VkRenderingAttachmentInfoKHR resolveImageView(long value) {
	...
	@NativeType("VkImageLayout")
	public VkRenderingAttachmentInfoKHR resolveImageLayout(int value) {
	...
	@NativeType("VkAttachmentLoadOp")
	public VkRenderingAttachmentInfoKHR loadOp(int value) {
	...
	@NativeType("VkAttachmentStoreOp")
	public VkRenderingAttachmentInfoKHR storeOp(int value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkRenderingAttachmentInfoKHR> {
		
		private static final StructConstructor<VkRenderingAttachmentInfoKHR> CONSTRUCTOR = VkRenderingAttachmentInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkRenderingAttachmentInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkRenderingAttachmentInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkRenderingAttachmentInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
