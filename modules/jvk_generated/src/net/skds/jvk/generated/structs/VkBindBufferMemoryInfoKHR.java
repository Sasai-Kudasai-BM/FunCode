...
public final class VkBindBufferMemoryInfoKHR extends CStruct {
	...
	public VkBindBufferMemoryInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkBindBufferMemoryInfoKHR(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkBindBufferMemoryInfoKHR> {
		
		private static final StructConstructor<VkBindBufferMemoryInfoKHR> CONSTRUCTOR = VkBindBufferMemoryInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkBindBufferMemoryInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkBindBufferMemoryInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkBindBufferMemoryInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
