...
public final class VkPipelineMultisampleStateCreateInfo extends CStruct {
	...
	public VkPipelineMultisampleStateCreateInfo sType$Default() {
		INT_HANDLE.get(this.segment, this.offset + S_TYPE_OFFSET, 24);
		return this;
	}
	...
	public int sampleShadingEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SAMPLE_SHADING_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineMultisampleStateCreateInfo sampleShadingEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + SAMPLE_SHADING_ENABLE_OFFSET, value);
		return this;
	}
	...
	public int alphaToCoverageEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + ALPHA_TO_COVERAGE_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineMultisampleStateCreateInfo alphaToCoverageEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + ALPHA_TO_COVERAGE_ENABLE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int alphaToOneEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + ALPHA_TO_ONE_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineMultisampleStateCreateInfo alphaToOneEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + ALPHA_TO_ONE_ENABLE_OFFSET, value);
		return this;
	}
