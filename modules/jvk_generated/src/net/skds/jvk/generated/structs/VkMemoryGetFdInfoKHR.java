...
public final class VkMemoryGetFdInfoKHR extends CStruct {
	...
	public VkMemoryGetFdInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkMemoryGetFdInfoKHR(MemorySegment segment, long offset) {
	...
	public VkMemoryGetFdInfoKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000074002);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkMemoryGetFdInfoKHR> {
		
		private static final StructConstructor<VkMemoryGetFdInfoKHR> CONSTRUCTOR = VkMemoryGetFdInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkMemoryGetFdInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkMemoryGetFdInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkMemoryGetFdInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
