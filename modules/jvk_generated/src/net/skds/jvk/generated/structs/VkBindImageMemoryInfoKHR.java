...
public final class VkBindImageMemoryInfoKHR extends CStruct {
	...
	public VkBindImageMemoryInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkBindImageMemoryInfoKHR(MemorySegment segment, long offset) {
	...
	public VkBindImageMemoryInfoKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000157001);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkBindImageMemoryInfoKHR> {
		
		private static final StructConstructor<VkBindImageMemoryInfoKHR> CONSTRUCTOR = VkBindImageMemoryInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkBindImageMemoryInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkBindImageMemoryInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkBindImageMemoryInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
