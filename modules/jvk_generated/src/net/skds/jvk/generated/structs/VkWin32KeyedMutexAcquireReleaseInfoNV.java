...
public final class VkWin32KeyedMutexAcquireReleaseInfoNV extends CStruct {
	...
	private static final int P_ACQUIRE_TIMEOUT_MILLISECONDS_OFFSET = 40;
	...
	public VkWin32KeyedMutexAcquireReleaseInfoNV(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkWin32KeyedMutexAcquireReleaseInfoNV(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_NV **/
	@NativeType("VkStructureType")
	public VkWin32KeyedMutexAcquireReleaseInfoNV sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000058000);
		return this;
	}
	...
	@NativeType("VkDeviceMemory**")
	public VkWin32KeyedMutexAcquireReleaseInfoNV pAcquireSyncs(long value) {
	...
	@NativeType("uint64_t*")
	public VkWin32KeyedMutexAcquireReleaseInfoNV pAcquireKeys(long value) {
	...
	public long pAcquireTimeoutMilliseconds() {
		return (long) LONG_HANDLE.get(this.segment, this.offset + P_ACQUIRE_TIMEOUT_MILLISECONDS_OFFSET);
	}
	
	@NativeType("uint32_t*")
	public VkWin32KeyedMutexAcquireReleaseInfoNV pAcquireTimeoutMilliseconds(long value) {
		LONG_HANDLE.set(this.segment, this.offset + P_ACQUIRE_TIMEOUT_MILLISECONDS_OFFSET, value);
		return this;
	}
	...
	@NativeType("VkDeviceMemory**")
	public VkWin32KeyedMutexAcquireReleaseInfoNV pReleaseSyncs(long value) {
	...
	@NativeType("uint64_t*")
	public VkWin32KeyedMutexAcquireReleaseInfoNV pReleaseKeys(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkWin32KeyedMutexAcquireReleaseInfoNV> {
		
		private static final StructConstructor<VkWin32KeyedMutexAcquireReleaseInfoNV> CONSTRUCTOR = VkWin32KeyedMutexAcquireReleaseInfoNV::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkWin32KeyedMutexAcquireReleaseInfoNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkWin32KeyedMutexAcquireReleaseInfoNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkWin32KeyedMutexAcquireReleaseInfoNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
