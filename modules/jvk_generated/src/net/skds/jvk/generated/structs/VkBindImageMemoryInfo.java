...
public final class VkBindImageMemoryInfo extends CStruct {
	...
	public VkBindImageMemoryInfo(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkBindImageMemoryInfo(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkBindImageMemoryInfo> {
		
		private static final StructConstructor<VkBindImageMemoryInfo> CONSTRUCTOR = VkBindImageMemoryInfo::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkBindImageMemoryInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkBindImageMemoryInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkBindImageMemoryInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
