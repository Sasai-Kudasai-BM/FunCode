...
public final class VkPhysicalDeviceSampleLocationsPropertiesEXT extends CStruct {
	...
	public float sampleLocationCoordinateRange(int i) {
		return (float) FLOAT_HANDLE.get(this.segment, this.offset + SAMPLE_LOCATION_COORDINATE_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i);
	}
	
	@NativeType("float[2]")
	public VkPhysicalDeviceSampleLocationsPropertiesEXT sampleLocationCoordinateRange(int i, float value) {
		FLOAT_HANDLE.set(this.segment, this.offset + SAMPLE_LOCATION_COORDINATE_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i, value);
		return this;
	}
	...
	public int variableSampleLocations() {
		return (int) INT_HANDLE.get(this.segment, this.offset + VARIABLE_SAMPLE_LOCATIONS_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceSampleLocationsPropertiesEXT variableSampleLocations(int value) {
		INT_HANDLE.set(this.segment, this.offset + VARIABLE_SAMPLE_LOCATIONS_OFFSET, value);
		return this;
	}
