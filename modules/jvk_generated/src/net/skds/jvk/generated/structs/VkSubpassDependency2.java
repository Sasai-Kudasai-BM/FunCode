...
public final class VkSubpassDependency2 extends CStruct {
	...
	public VkSubpassDependency2(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkSubpassDependency2(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkSubpassDependency2> {
		
		private static final StructConstructor<VkSubpassDependency2> CONSTRUCTOR = VkSubpassDependency2::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkSubpassDependency2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkSubpassDependency2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkSubpassDependency2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
