...
**/
@AutoGenerated
public final class VkImportFenceWin32HandleInfoKHR extends CStruct {
	...
	public VkImportFenceWin32HandleInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkImportFenceWin32HandleInfoKHR(MemorySegment segment, long offset) {
	...
	public VkImportFenceWin32HandleInfoKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000114000);
		return this;
	}
	...
	/** optional **/
	@NativeType("LPCWSTR*")
	public VkImportFenceWin32HandleInfoKHR name(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkImportFenceWin32HandleInfoKHR> {
		
		private static final StructConstructor<VkImportFenceWin32HandleInfoKHR> CONSTRUCTOR = VkImportFenceWin32HandleInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkImportFenceWin32HandleInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkImportFenceWin32HandleInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkImportFenceWin32HandleInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
