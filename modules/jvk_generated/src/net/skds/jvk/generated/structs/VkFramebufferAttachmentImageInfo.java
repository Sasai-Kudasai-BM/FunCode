...
**/
@AutoGenerated
public final class VkFramebufferAttachmentImageInfo extends CStruct {
	...
	public VkFramebufferAttachmentImageInfo(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkFramebufferAttachmentImageInfo(MemorySegment segment, long offset) {
	...
	@NativeType("VkFormat*")
	public VkFramebufferAttachmentImageInfo pViewFormats(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkFramebufferAttachmentImageInfo> {
		
		private static final StructConstructor<VkFramebufferAttachmentImageInfo> CONSTRUCTOR = VkFramebufferAttachmentImageInfo::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkFramebufferAttachmentImageInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkFramebufferAttachmentImageInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkFramebufferAttachmentImageInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
