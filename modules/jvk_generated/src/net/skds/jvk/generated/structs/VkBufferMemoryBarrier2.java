...
public final class VkBufferMemoryBarrier2 extends CStruct {
	...
	public VkBufferMemoryBarrier2(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkBufferMemoryBarrier2(MemorySegment segment, long offset) {
	...
	public VkBufferMemoryBarrier2 sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000314001);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkBufferMemoryBarrier2> {
		
		private static final StructConstructor<VkBufferMemoryBarrier2> CONSTRUCTOR = VkBufferMemoryBarrier2::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkBufferMemoryBarrier2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkBufferMemoryBarrier2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkBufferMemoryBarrier2[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
