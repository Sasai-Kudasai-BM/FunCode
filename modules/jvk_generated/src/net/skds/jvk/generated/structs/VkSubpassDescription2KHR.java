...
public final class VkSubpassDescription2KHR extends CStruct {
	...
	public VkSubpassDescription2KHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkSubpassDescription2KHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2 **/
	@NativeType("VkStructureType")
	public VkSubpassDescription2KHR sType$Default() {
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkSubpassDescription2KHR inputAttachmentCount(int value) {
	...
	@NativeType("VkAttachmentReference2*")
	public VkSubpassDescription2KHR pInputAttachments(long value) {
	...
	@NativeType("VkAttachmentReference2*")
	public VkSubpassDescription2KHR pColorAttachments(long value) {
	...
	/** optional **/
	@NativeType("VkAttachmentReference2*")
	public VkSubpassDescription2KHR pResolveAttachments(long value) {
	...
	/** optional **/
	@NativeType("VkAttachmentReference2*")
	public VkSubpassDescription2KHR pDepthStencilAttachment(long value) {
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkSubpassDescription2KHR preserveAttachmentCount(int value) {
	...
	@NativeType("uint32_t*")
	public VkSubpassDescription2KHR pPreserveAttachments(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkSubpassDescription2KHR> {
		
		private static final StructConstructor<VkSubpassDescription2KHR> CONSTRUCTOR = VkSubpassDescription2KHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkSubpassDescription2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkSubpassDescription2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkSubpassDescription2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
