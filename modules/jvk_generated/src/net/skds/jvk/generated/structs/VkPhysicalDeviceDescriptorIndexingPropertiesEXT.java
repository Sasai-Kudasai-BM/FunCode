...
public final class VkPhysicalDeviceDescriptorIndexingPropertiesEXT extends CStruct {
	...
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT sType$Default() {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxUpdateAfterBindDescriptorsInAllPools(int value) {
	...
	public int shaderUniformBufferArrayNonUniformIndexingNative() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SHADER_UNIFORM_BUFFER_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT shaderUniformBufferArrayNonUniformIndexingNative(int value) {
		INT_HANDLE.set(this.segment, this.offset + SHADER_UNIFORM_BUFFER_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int shaderSampledImageArrayNonUniformIndexingNative() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SHADER_SAMPLED_IMAGE_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT shaderSampledImageArrayNonUniformIndexingNative(int value) {
		INT_HANDLE.set(this.segment, this.offset + SHADER_SAMPLED_IMAGE_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int shaderStorageBufferArrayNonUniformIndexingNative() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SHADER_STORAGE_BUFFER_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT shaderStorageBufferArrayNonUniformIndexingNative(int value) {
		INT_HANDLE.set(this.segment, this.offset + SHADER_STORAGE_BUFFER_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int shaderStorageImageArrayNonUniformIndexingNative() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SHADER_STORAGE_IMAGE_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT shaderStorageImageArrayNonUniformIndexingNative(int value) {
		INT_HANDLE.set(this.segment, this.offset + SHADER_STORAGE_IMAGE_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int shaderInputAttachmentArrayNonUniformIndexingNative() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SHADER_INPUT_ATTACHMENT_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT shaderInputAttachmentArrayNonUniformIndexingNative(int value) {
		INT_HANDLE.set(this.segment, this.offset + SHADER_INPUT_ATTACHMENT_ARRAY_NON_UNIFORM_INDEXING_NATIVE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int robustBufferAccessUpdateAfterBind() {
		return (int) INT_HANDLE.get(this.segment, this.offset + ROBUST_BUFFER_ACCESS_UPDATE_AFTER_BIND_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT robustBufferAccessUpdateAfterBind(int value) {
		INT_HANDLE.set(this.segment, this.offset + ROBUST_BUFFER_ACCESS_UPDATE_AFTER_BIND_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int quadDivergentImplicitLod() {
		return (int) INT_HANDLE.get(this.segment, this.offset + QUAD_DIVERGENT_IMPLICIT_LOD_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT quadDivergentImplicitLod(int value) {
		INT_HANDLE.set(this.segment, this.offset + QUAD_DIVERGENT_IMPLICIT_LOD_OFFSET, value);
		return this;
	}
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageDescriptorUpdateAfterBindSamplers(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageDescriptorUpdateAfterBindUniformBuffers(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageDescriptorUpdateAfterBindStorageBuffers(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageDescriptorUpdateAfterBindSampledImages(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageDescriptorUpdateAfterBindStorageImages(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageDescriptorUpdateAfterBindInputAttachments(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxPerStageUpdateAfterBindResources(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindSamplers(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindUniformBuffers(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindUniformBuffersDynamic(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindStorageBuffers(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindStorageBuffersDynamic(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindSampledImages(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindStorageImages(int value) {
	...
	@NativeType("uint32_t")
	public VkPhysicalDeviceDescriptorIndexingPropertiesEXT maxDescriptorSetUpdateAfterBindInputAttachments(int value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceDescriptorIndexingPropertiesEXT> {
		
		private static final StructConstructor<VkPhysicalDeviceDescriptorIndexingPropertiesEXT> CONSTRUCTOR = VkPhysicalDeviceDescriptorIndexingPropertiesEXT::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceDescriptorIndexingPropertiesEXT[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceDescriptorIndexingPropertiesEXT[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceDescriptorIndexingPropertiesEXT[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
