...
public final class VkPipelineExecutableInternalRepresentationKHR extends CStruct {
	...
	public VkPipelineExecutableInternalRepresentationKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000269005);
		return this;
	}
	...
	@NativeType("char[256]")
	public VkPipelineExecutableInternalRepresentationKHR name(byte[] value) {
		MemorySegment.copy(value, 0, this.segment, BYTE, this.offset + NAME_OFFSET, value.length);
		return this;
	}
	
	@NativeType("char[256]")
	public VkPipelineExecutableInternalRepresentationKHR name(String value) {
	...
	@NativeType("char[256]")
	public VkPipelineExecutableInternalRepresentationKHR description(byte[] value) {
		MemorySegment.copy(value, 0, this.segment, BYTE, this.offset + DESCRIPTION_OFFSET, value.length);
		return this;
	}
	
	@NativeType("char[256]")
	public VkPipelineExecutableInternalRepresentationKHR description(String value) {
	...
	public static final class Array extends VkStructArray<VkPipelineExecutableInternalRepresentationKHR> {
		...
		private static final StructConstructor<VkPipelineExecutableInternalRepresentationKHR> CONSTRUCTOR = VkPipelineExecutableInternalRepresentationKHR::new;
