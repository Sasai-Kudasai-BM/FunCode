...
**/
@AutoGenerated
public final class VkRenderPassCreateInfo2KHR extends CStruct {
	...
	public VkRenderPassCreateInfo2KHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkRenderPassCreateInfo2KHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2 **/
	@NativeType("VkStructureType")
	public VkRenderPassCreateInfo2KHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000109004);
		return this;
	}
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkRenderPassCreateInfo2KHR attachmentCount(int value) {
	...
	@NativeType("VkAttachmentDescription2*")
	public VkRenderPassCreateInfo2KHR pAttachments(long value) {
	...
	@NativeType("uint32_t")
	public VkRenderPassCreateInfo2KHR subpassCount(int value) {
	...
	@NativeType("VkSubpassDescription2*")
	public VkRenderPassCreateInfo2KHR pSubpasses(long value) {
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkRenderPassCreateInfo2KHR dependencyCount(int value) {
	...
	@NativeType("VkSubpassDependency2*")
	public VkRenderPassCreateInfo2KHR pDependencies(long value) {
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkRenderPassCreateInfo2KHR correlatedViewMaskCount(int value) {
	...
	@NativeType("uint32_t*")
	public VkRenderPassCreateInfo2KHR pCorrelatedViewMasks(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkRenderPassCreateInfo2KHR> {
		
		private static final StructConstructor<VkRenderPassCreateInfo2KHR> CONSTRUCTOR = VkRenderPassCreateInfo2KHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkRenderPassCreateInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkRenderPassCreateInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkRenderPassCreateInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
