...
public final class VkExternalMemoryPropertiesKHR extends CStruct {
	...
	public VkExternalMemoryPropertiesKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkExternalMemoryPropertiesKHR(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkExternalMemoryPropertiesKHR> {
		
		private static final StructConstructor<VkExternalMemoryPropertiesKHR> CONSTRUCTOR = VkExternalMemoryPropertiesKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkExternalMemoryPropertiesKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkExternalMemoryPropertiesKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkExternalMemoryPropertiesKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
