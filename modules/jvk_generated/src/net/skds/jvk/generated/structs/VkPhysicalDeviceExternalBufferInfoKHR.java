...
public final class VkPhysicalDeviceExternalBufferInfoKHR extends CStruct {
	...
	public VkPhysicalDeviceExternalBufferInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceExternalBufferInfoKHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceExternalBufferInfoKHR sType$Default() {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceExternalBufferInfoKHR> {
		
		private static final StructConstructor<VkPhysicalDeviceExternalBufferInfoKHR> CONSTRUCTOR = VkPhysicalDeviceExternalBufferInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceExternalBufferInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceExternalBufferInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceExternalBufferInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
