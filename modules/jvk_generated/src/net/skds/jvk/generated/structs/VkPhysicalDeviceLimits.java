...
public final class VkPhysicalDeviceLimits extends CStruct {
	...
	public int maxComputeWorkGroupCount(int i) {
		return (int) INT_HANDLE.get(this.segment, this.offset + MAX_COMPUTE_WORK_GROUP_COUNT_OFFSET + ValueLayout.JAVA_INT.byteSize() * i);
	}
	
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceLimits maxComputeWorkGroupCount(int i, int value) {
		INT_HANDLE.set(this.segment, this.offset + MAX_COMPUTE_WORK_GROUP_COUNT_OFFSET + ValueLayout.JAVA_INT.byteSize() * i, value);
		return this;
	}
	...
	public int maxComputeWorkGroupSize(int i) {
		return (int) INT_HANDLE.get(this.segment, this.offset + MAX_COMPUTE_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i);
	}
	
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceLimits maxComputeWorkGroupSize(int i, int value) {
		INT_HANDLE.set(this.segment, this.offset + MAX_COMPUTE_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i, value);
		return this;
	}
	...
	public int maxViewportDimensions(int i) {
		return (int) INT_HANDLE.get(this.segment, this.offset + MAX_VIEWPORT_DIMENSIONS_OFFSET + ValueLayout.JAVA_INT.byteSize() * i);
	}
	
	@NativeType("uint32_t[2]")
	public VkPhysicalDeviceLimits maxViewportDimensions(int i, int value) {
		INT_HANDLE.set(this.segment, this.offset + MAX_VIEWPORT_DIMENSIONS_OFFSET + ValueLayout.JAVA_INT.byteSize() * i, value);
		return this;
	}
	
	@NativeType("float[2]")
	public float viewportBoundsRange(int i) {
		return (float) FLOAT_HANDLE.get(this.segment, this.offset + VIEWPORT_BOUNDS_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i);
	}
	
	@NativeType("float[2]")
	public VkPhysicalDeviceLimits viewportBoundsRange(int i, float value) {
		FLOAT_HANDLE.set(this.segment, this.offset + VIEWPORT_BOUNDS_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i, value);
		return this;
	}
	...
	public float pointSizeRange(int i) {
		return (float) FLOAT_HANDLE.get(this.segment, this.offset + POINT_SIZE_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i);
	}
	
	@NativeType("float[2]")
	public VkPhysicalDeviceLimits pointSizeRange(int i, float value) {
		FLOAT_HANDLE.set(this.segment, this.offset + POINT_SIZE_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i, value);
		return this;
	}
	
	@NativeType("float[2]")
	public float lineWidthRange(int i) {
		return (float) FLOAT_HANDLE.get(this.segment, this.offset + LINE_WIDTH_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i);
	}
	
	@NativeType("float[2]")
	public VkPhysicalDeviceLimits lineWidthRange(int i, float value) {
		FLOAT_HANDLE.set(this.segment, this.offset + LINE_WIDTH_RANGE_OFFSET + ValueLayout.JAVA_FLOAT.byteSize() * i, value);
		return this;
	}
