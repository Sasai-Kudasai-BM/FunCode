...
public final class VkPhysicalDeviceLimits extends CStruct {
	...
	@NativeType("uint32_t[3]")
	public int[] maxComputeWorkGroupCountArray() {
		var array = new int[3];
		MemorySegment.copy(this.segment, INT, this.offset + MAX_COMPUTE_WORK_GROUP_COUNT_OFFSET, array, 0, array.length);
		return array;
	}
	...
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceLimits maxComputeWorkGroupCount(int[] value) {
		MemorySegment.copy(value, 0, this.segment, INT, this.offset + MAX_COMPUTE_WORK_GROUP_COUNT_OFFSET, value.length);
		return this;
	}
	...
	@NativeType("uint32_t[3]")
	public int[] maxComputeWorkGroupSizeArray() {
		var array = new int[3];
		MemorySegment.copy(this.segment, INT, this.offset + MAX_COMPUTE_WORK_GROUP_SIZE_OFFSET, array, 0, array.length);
		return array;
	}
	...
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceLimits maxComputeWorkGroupSize(int[] value) {
		MemorySegment.copy(value, 0, this.segment, INT, this.offset + MAX_COMPUTE_WORK_GROUP_SIZE_OFFSET, value.length);
		return this;
	}
	...
	@NativeType("uint32_t[2]")
	public int[] maxViewportDimensionsArray() {
		var array = new int[2];
		MemorySegment.copy(this.segment, INT, this.offset + MAX_VIEWPORT_DIMENSIONS_OFFSET, array, 0, array.length);
		return array;
	}
	...
	@NativeType("uint32_t[2]")
	public VkPhysicalDeviceLimits maxViewportDimensions(int[] value) {
		MemorySegment.copy(value, 0, this.segment, INT, this.offset + MAX_VIEWPORT_DIMENSIONS_OFFSET, value.length);
		return this;
	}
	...
	@NativeType("float[2]")
	public float[] viewportBoundsRangeArray() {
		var array = new float[2];
		MemorySegment.copy(this.segment, FLOAT, this.offset + VIEWPORT_BOUNDS_RANGE_OFFSET, array, 0, array.length);
		return array;
	}
	...
	@NativeType("float[2]")
	public VkPhysicalDeviceLimits viewportBoundsRange(float[] value) {
		MemorySegment.copy(value, 0, this.segment, FLOAT, this.offset + VIEWPORT_BOUNDS_RANGE_OFFSET, value.length);
		return this;
	}
	...
	public boolean timestampComputeAndGraphics() {
		return (int) INT_HANDLE.get(this.segment, this.offset + TIMESTAMP_COMPUTE_AND_GRAPHICS_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceLimits timestampComputeAndGraphics(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + TIMESTAMP_COMPUTE_AND_GRAPHICS_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	...
	@NativeType("float[2]")
	public float[] pointSizeRangeArray() {
		var array = new float[2];
		MemorySegment.copy(this.segment, FLOAT, this.offset + POINT_SIZE_RANGE_OFFSET, array, 0, array.length);
		return array;
	}
	...
	@NativeType("float[2]")
	public VkPhysicalDeviceLimits pointSizeRange(float[] value) {
		MemorySegment.copy(value, 0, this.segment, FLOAT, this.offset + POINT_SIZE_RANGE_OFFSET, value.length);
		return this;
	}
	...
	@NativeType("float[2]")
	public float[] lineWidthRangeArray() {
		var array = new float[2];
		MemorySegment.copy(this.segment, FLOAT, this.offset + LINE_WIDTH_RANGE_OFFSET, array, 0, array.length);
		return array;
	}
	...
	@NativeType("float[2]")
	public VkPhysicalDeviceLimits lineWidthRange(float[] value) {
		MemorySegment.copy(value, 0, this.segment, FLOAT, this.offset + LINE_WIDTH_RANGE_OFFSET, value.length);
		return this;
	}
	...
	public boolean strictLines() {
		return (int) INT_HANDLE.get(this.segment, this.offset + STRICT_LINES_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceLimits strictLines(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + STRICT_LINES_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean standardSampleLocations() {
		return (int) INT_HANDLE.get(this.segment, this.offset + STANDARD_SAMPLE_LOCATIONS_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceLimits standardSampleLocations(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + STANDARD_SAMPLE_LOCATIONS_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
