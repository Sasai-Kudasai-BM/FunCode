...
public final class VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT extends CStruct {
	...
	public int vertexAttributeInstanceRateDivisor() {
		return (int) INT_HANDLE.get(this.segment, this.offset + VERTEX_ATTRIBUTE_INSTANCE_RATE_DIVISOR_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT vertexAttributeInstanceRateDivisor(int value) {
		INT_HANDLE.set(this.segment, this.offset + VERTEX_ATTRIBUTE_INSTANCE_RATE_DIVISOR_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int vertexAttributeInstanceRateZeroDivisor() {
		return (int) INT_HANDLE.get(this.segment, this.offset + VERTEX_ATTRIBUTE_INSTANCE_RATE_ZERO_DIVISOR_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceVertexAttributeDivisorFeaturesEXT vertexAttributeInstanceRateZeroDivisor(int value) {
		INT_HANDLE.set(this.segment, this.offset + VERTEX_ATTRIBUTE_INSTANCE_RATE_ZERO_DIVISOR_OFFSET, value);
		return this;
	}
