...
public final class VkPipelineDepthStencilStateCreateInfo extends CStruct {
	...
	public VkPipelineDepthStencilStateCreateInfo sType$Default() {
		INT_HANDLE.get(this.segment, this.offset + S_TYPE_OFFSET, 25);
		return this;
	}
	...
	public int depthTestEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEPTH_TEST_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineDepthStencilStateCreateInfo depthTestEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + DEPTH_TEST_ENABLE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int depthWriteEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEPTH_WRITE_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineDepthStencilStateCreateInfo depthWriteEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + DEPTH_WRITE_ENABLE_OFFSET, value);
		return this;
	}
	...
	public int depthBoundsTestEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEPTH_BOUNDS_TEST_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineDepthStencilStateCreateInfo depthBoundsTestEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + DEPTH_BOUNDS_TEST_ENABLE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int stencilTestEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + STENCIL_TEST_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineDepthStencilStateCreateInfo stencilTestEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + STENCIL_TEST_ENABLE_OFFSET, value);
		return this;
	}
