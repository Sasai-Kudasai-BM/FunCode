...
public final class VkPhysicalDeviceConservativeRasterizationPropertiesEXT extends CStruct {
	...
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000101000);
		return this;
	}
	...
	public boolean primitiveUnderestimation() {
		return (int) INT_HANDLE.get(this.segment, this.offset + PRIMITIVE_UNDERESTIMATION_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT primitiveUnderestimation(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + PRIMITIVE_UNDERESTIMATION_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean conservativePointAndLineRasterization() {
		return (int) INT_HANDLE.get(this.segment, this.offset + CONSERVATIVE_POINT_AND_LINE_RASTERIZATION_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT conservativePointAndLineRasterization(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + CONSERVATIVE_POINT_AND_LINE_RASTERIZATION_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean degenerateTrianglesRasterized() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEGENERATE_TRIANGLES_RASTERIZED_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT degenerateTrianglesRasterized(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + DEGENERATE_TRIANGLES_RASTERIZED_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean degenerateLinesRasterized() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEGENERATE_LINES_RASTERIZED_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT degenerateLinesRasterized(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + DEGENERATE_LINES_RASTERIZED_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean fullyCoveredFragmentShaderInputVariable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + FULLY_COVERED_FRAGMENT_SHADER_INPUT_VARIABLE_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT fullyCoveredFragmentShaderInputVariable(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + FULLY_COVERED_FRAGMENT_SHADER_INPUT_VARIABLE_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean conservativeRasterizationPostDepthCoverage() {
		return (int) INT_HANDLE.get(this.segment, this.offset + CONSERVATIVE_RASTERIZATION_POST_DEPTH_COVERAGE_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceConservativeRasterizationPropertiesEXT conservativeRasterizationPostDepthCoverage(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + CONSERVATIVE_RASTERIZATION_POST_DEPTH_COVERAGE_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	...
	public static final class Array extends VkStructArray<VkPhysicalDeviceConservativeRasterizationPropertiesEXT> {
		...
		private static final StructConstructor<VkPhysicalDeviceConservativeRasterizationPropertiesEXT> CONSTRUCTOR = VkPhysicalDeviceConservativeRasterizationPropertiesEXT::new;
