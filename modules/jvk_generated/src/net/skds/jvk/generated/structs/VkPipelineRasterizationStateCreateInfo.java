...
public final class VkPipelineRasterizationStateCreateInfo extends CStruct {
	...
	public VkPipelineRasterizationStateCreateInfo sType$Default() {
		INT_HANDLE.get(this.segment, this.offset + S_TYPE_OFFSET, 23);
		return this;
	}
	...
	public int depthClampEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEPTH_CLAMP_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineRasterizationStateCreateInfo depthClampEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + DEPTH_CLAMP_ENABLE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int rasterizerDiscardEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + RASTERIZER_DISCARD_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineRasterizationStateCreateInfo rasterizerDiscardEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + RASTERIZER_DISCARD_ENABLE_OFFSET, value);
		return this;
	}
	...
	public int depthBiasEnable() {
		return (int) INT_HANDLE.get(this.segment, this.offset + DEPTH_BIAS_ENABLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPipelineRasterizationStateCreateInfo depthBiasEnable(int value) {
		INT_HANDLE.set(this.segment, this.offset + DEPTH_BIAS_ENABLE_OFFSET, value);
		return this;
	}
