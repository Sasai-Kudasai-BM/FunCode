...
public final class VkPhysicalDeviceIDPropertiesKHR extends CStruct {
	...
	public VkPhysicalDeviceIDPropertiesKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000071004);
		return this;
	}
	...
	@NativeType("uint8_t[16]")
	public VkPhysicalDeviceIDPropertiesKHR deviceUUID(byte[] value) {
	...
	@NativeType("uint8_t[16]")
	public VkPhysicalDeviceIDPropertiesKHR driverUUID(byte[] value) {
	...
	@NativeType("uint8_t[8]")
	public VkPhysicalDeviceIDPropertiesKHR deviceLUID(byte[] value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceIDPropertiesKHR deviceLUIDValid(boolean value) {
