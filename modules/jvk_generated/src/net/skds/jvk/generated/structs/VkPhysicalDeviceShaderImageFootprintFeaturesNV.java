...
public final class VkPhysicalDeviceShaderImageFootprintFeaturesNV extends CStruct {
	...
	public int imageFootprint() {
		return (int) INT_HANDLE.get(this.segment, this.offset + IMAGE_FOOTPRINT_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceShaderImageFootprintFeaturesNV imageFootprint(int value) {
		INT_HANDLE.set(this.segment, this.offset + IMAGE_FOOTPRINT_OFFSET, value);
		return this;
	}
