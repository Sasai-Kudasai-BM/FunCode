...
**/
@AutoGenerated
public final class VkPhysicalDeviceHostImageCopyProperties extends CStruct {
	...
	public VkPhysicalDeviceHostImageCopyProperties(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceHostImageCopyProperties(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceHostImageCopyProperties sType(int value) {
	...
	/** optional **/
	@NativeType("void*")
	public VkPhysicalDeviceHostImageCopyProperties pNext(long value) {
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkPhysicalDeviceHostImageCopyProperties copySrcLayoutCount(int value) {
	...
	/** optional **/
	@NativeType("VkImageLayout*")
	public VkPhysicalDeviceHostImageCopyProperties pCopySrcLayouts(long value) {
	...
	/** optional **/
	@NativeType("uint32_t")
	public VkPhysicalDeviceHostImageCopyProperties copyDstLayoutCount(int value) {
	...
	/** optional **/
	@NativeType("VkImageLayout*")
	public VkPhysicalDeviceHostImageCopyProperties pCopyDstLayouts(long value) {
	...
	/** optional **/
	@NativeType("uint8_t[16]")
	public VkPhysicalDeviceHostImageCopyProperties optimalTilingLayoutUUID(int i, byte value) {
	...
	/** optional **/
	@NativeType("uint8_t[16]")
	public VkPhysicalDeviceHostImageCopyProperties optimalTilingLayoutUUID(byte[] value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceHostImageCopyProperties identicalMemoryTypeRequirements(boolean value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceHostImageCopyProperties> {
		
		private static final StructConstructor<VkPhysicalDeviceHostImageCopyProperties> CONSTRUCTOR = VkPhysicalDeviceHostImageCopyProperties::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceHostImageCopyProperties[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceHostImageCopyProperties[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceHostImageCopyProperties[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
