...
public final class VkPhysicalDeviceImageFormatInfo2KHR extends CStruct {
	...
	private static final int TILING_OFFSET = 24;
	...
	public VkPhysicalDeviceImageFormatInfo2KHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceImageFormatInfo2KHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2 **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceImageFormatInfo2KHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000059004);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceImageFormatInfo2KHR> {
		
		private static final StructConstructor<VkPhysicalDeviceImageFormatInfo2KHR> CONSTRUCTOR = VkPhysicalDeviceImageFormatInfo2KHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceImageFormatInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceImageFormatInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceImageFormatInfo2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
