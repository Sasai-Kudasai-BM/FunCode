...
public final class VkImageMemoryBarrier2KHR extends CStruct {
	...
	public VkImageMemoryBarrier2KHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkImageMemoryBarrier2KHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2 **/
	@NativeType("VkStructureType")
	public VkImageMemoryBarrier2KHR sType(int value) {
	...
	/** values = VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2 **/
	@NativeType("VkStructureType")
	public VkImageMemoryBarrier2KHR sType$Default() {
	...
	/** optional **/
	@NativeType("void*")
	public VkImageMemoryBarrier2KHR pNext(long value) {
	...
	/** optional **/
	@NativeType("VkPipelineStageFlags2")
	public VkImageMemoryBarrier2KHR srcStageMask(long value) {
	...
	/** optional **/
	@NativeType("VkAccessFlags2")
	public VkImageMemoryBarrier2KHR srcAccessMask(long value) {
	...
	/** optional **/
	@NativeType("VkPipelineStageFlags2")
	public VkImageMemoryBarrier2KHR dstStageMask(long value) {
	...
	/** optional **/
	@NativeType("VkAccessFlags2")
	public VkImageMemoryBarrier2KHR dstAccessMask(long value) {
	...
	@NativeType("VkImageLayout")
	public VkImageMemoryBarrier2KHR oldLayout(int value) {
	...
	@NativeType("VkImageLayout")
	public VkImageMemoryBarrier2KHR newLayout(int value) {
	...
	@NativeType("uint32_t")
	public VkImageMemoryBarrier2KHR srcQueueFamilyIndex(int value) {
	...
	@NativeType("uint32_t")
	public VkImageMemoryBarrier2KHR dstQueueFamilyIndex(int value) {
	...
	@NativeType("VkImage*")
	public VkImageMemoryBarrier2KHR image(long value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkImageMemoryBarrier2KHR> {
		
		private static final StructConstructor<VkImageMemoryBarrier2KHR> CONSTRUCTOR = VkImageMemoryBarrier2KHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkImageMemoryBarrier2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkImageMemoryBarrier2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkImageMemoryBarrier2KHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
