...
public final class VkPhysicalDevice4444FormatsFeaturesEXT extends CStruct {
	...
	public int formatA4R4G4B4() {
		return (int) INT_HANDLE.get(this.segment, this.offset + FORMAT_A4_R4_G4_B4_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDevice4444FormatsFeaturesEXT formatA4R4G4B4(int value) {
		INT_HANDLE.set(this.segment, this.offset + FORMAT_A4_R4_G4_B4_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int formatA4B4G4R4() {
		return (int) INT_HANDLE.get(this.segment, this.offset + FORMAT_A4_B4_G4_R4_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDevice4444FormatsFeaturesEXT formatA4B4G4R4(int value) {
		INT_HANDLE.set(this.segment, this.offset + FORMAT_A4_B4_G4_R4_OFFSET, value);
		return this;
	}
