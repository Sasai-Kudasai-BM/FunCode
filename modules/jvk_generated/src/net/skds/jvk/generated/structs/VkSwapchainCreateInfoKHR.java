...
public final class VkSwapchainCreateInfoKHR extends CStruct {
	...
	public VkSwapchainCreateInfoKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000001000);
		return this;
	}
	...
	public boolean clipped() {
		return (int) INT_HANDLE.get(this.segment, this.offset + CLIPPED_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkSwapchainCreateInfoKHR clipped(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + CLIPPED_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	...
	public static final class Array extends VkStructArray<VkSwapchainCreateInfoKHR> {
		...
		private static final StructConstructor<VkSwapchainCreateInfoKHR> CONSTRUCTOR = VkSwapchainCreateInfoKHR::new;
