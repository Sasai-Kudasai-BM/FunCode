...
public final class VkPhysicalDeviceDriverProperties extends CStruct {
	...
	@NativeType("char[256]")
	public VkPhysicalDeviceDriverProperties driverName(byte[] value) {
		MemorySegment.copy(value, 0, this.segment, BYTE, this.offset + DRIVER_NAME_OFFSET, value.length);
		return this;
	}
	
	@NativeType("char[256]")
	public VkPhysicalDeviceDriverProperties driverName(String value) {
	...
	@NativeType("char[256]")
	public VkPhysicalDeviceDriverProperties driverInfo(byte[] value) {
		MemorySegment.copy(value, 0, this.segment, BYTE, this.offset + DRIVER_INFO_OFFSET, value.length);
		return this;
	}
	
	@NativeType("char[256]")
	public VkPhysicalDeviceDriverProperties driverInfo(String value) {
	...
	public static final class Array extends VkStructArray<VkPhysicalDeviceDriverProperties> {
		...
		private static final StructConstructor<VkPhysicalDeviceDriverProperties> CONSTRUCTOR = VkPhysicalDeviceDriverProperties::new;
