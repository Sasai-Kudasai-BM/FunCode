...
public final class VkDisplayPropertiesKHR extends CStruct {
	...
	public int planeReorderPossible() {
		return (int) INT_HANDLE.get(this.segment, this.offset + PLANE_REORDER_POSSIBLE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkDisplayPropertiesKHR planeReorderPossible(int value) {
		INT_HANDLE.set(this.segment, this.offset + PLANE_REORDER_POSSIBLE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int persistentContent() {
		return (int) INT_HANDLE.get(this.segment, this.offset + PERSISTENT_CONTENT_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkDisplayPropertiesKHR persistentContent(int value) {
		INT_HANDLE.set(this.segment, this.offset + PERSISTENT_CONTENT_OFFSET, value);
		return this;
	}
