...
**/
@AutoGenerated
public final class VkPhysicalDeviceBufferAddressFeaturesEXT extends CStruct {
	...
	public VkPhysicalDeviceBufferAddressFeaturesEXT(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkPhysicalDeviceBufferAddressFeaturesEXT(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT **/
	@NativeType("VkStructureType")
	public VkPhysicalDeviceBufferAddressFeaturesEXT sType$Default() {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceBufferAddressFeaturesEXT bufferDeviceAddress(int value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceBufferAddressFeaturesEXT bufferDeviceAddressCaptureReplay(int value) {
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceBufferAddressFeaturesEXT bufferDeviceAddressMultiDevice(int value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkPhysicalDeviceBufferAddressFeaturesEXT> {
		
		private static final StructConstructor<VkPhysicalDeviceBufferAddressFeaturesEXT> CONSTRUCTOR = VkPhysicalDeviceBufferAddressFeaturesEXT::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkPhysicalDeviceBufferAddressFeaturesEXT[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkPhysicalDeviceBufferAddressFeaturesEXT[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkPhysicalDeviceBufferAddressFeaturesEXT[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
