...
**/
@AutoGenerated
public final class VkMemoryMapInfo extends CStruct {
	...
	public VkMemoryMapInfo(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkMemoryMapInfo(MemorySegment segment, long offset) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkMemoryMapInfo> {
		
		private static final StructConstructor<VkMemoryMapInfo> CONSTRUCTOR = VkMemoryMapInfo::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkMemoryMapInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkMemoryMapInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkMemoryMapInfo[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
