...
public final class VkShaderStatisticsInfoAMD extends CStruct {
	...
	public int computeWorkGroupSize(int i) {
		return (int) INT_HANDLE.get(this.segment, this.offset + COMPUTE_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i);
	}
	
	@NativeType("uint32_t[3]")
	public VkShaderStatisticsInfoAMD computeWorkGroupSize(int i, int value) {
		INT_HANDLE.set(this.segment, this.offset + COMPUTE_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i, value);
		return this;
	}
