...
**/
@AutoGenerated
public final class VkCopyMemoryToImageIndirectCommandNV extends CStruct {
	...
	public VkCopyMemoryToImageIndirectCommandNV(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkCopyMemoryToImageIndirectCommandNV(MemorySegment segment, long offset) {
	...
	@NativeType("VkDeviceAddress")
	public VkCopyMemoryToImageIndirectCommandNV srcAddress(long value) {
	...
	@NativeType("uint32_t")
	public VkCopyMemoryToImageIndirectCommandNV bufferRowLength(int value) {
	...
	@NativeType("uint32_t")
	public VkCopyMemoryToImageIndirectCommandNV bufferImageHeight(int value) {
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkCopyMemoryToImageIndirectCommandNV> {
		
		private static final StructConstructor<VkCopyMemoryToImageIndirectCommandNV> CONSTRUCTOR = VkCopyMemoryToImageIndirectCommandNV::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkCopyMemoryToImageIndirectCommandNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkCopyMemoryToImageIndirectCommandNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkCopyMemoryToImageIndirectCommandNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
