...
**/
@AutoGenerated
public final class VkAccelerationStructureGeometryLinearSweptSpheresDataNV extends CStruct {
	...
	private static final int INDEXING_MODE_OFFSET = 88;
	private static final int END_CAPS_MODE_OFFSET = 92;
	
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV() {
		this.segment = Arena.ofAuto().allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV **/
	@NativeType("VkStructureType")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV sType(int value) {
	...
	/** values = VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_LINEAR_SWEPT_SPHERES_DATA_NV **/
	@NativeType("VkStructureType")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000429009);
		return this;
	}
	...
	/** optional **/
	@NativeType("void*")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV pNext(long value) {
	...
	@NativeType("VkFormat")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV vertexFormat(int value) {
	...
	@NativeType("VkDeviceSize")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV vertexStride(long value) {
	...
	@NativeType("VkFormat")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV radiusFormat(int value) {
	...
	@NativeType("VkDeviceSize")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV radiusStride(long value) {
	...
	@NativeType("VkIndexType")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV indexType(int value) {
	...
	@NativeType("VkDeviceSize")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV indexStride(long value) {
	...
	public int indexingMode() {
		return (int) INT_HANDLE.get(this.segment, this.offset + INDEXING_MODE_OFFSET);
	}
	
	@NativeType("VkRayTracingLssIndexingModeNV")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV indexingMode(int value) {
		INT_HANDLE.set(this.segment, this.offset + INDEXING_MODE_OFFSET, value);
		return this;
	}
	
	@NativeType("VkRayTracingLssPrimitiveEndCapsModeNV")
	public int endCapsMode() {
		return (int) INT_HANDLE.get(this.segment, this.offset + END_CAPS_MODE_OFFSET);
	}
	
	@NativeType("VkRayTracingLssPrimitiveEndCapsModeNV")
	public VkAccelerationStructureGeometryLinearSweptSpheresDataNV endCapsMode(int value) {
		INT_HANDLE.set(this.segment, this.offset + END_CAPS_MODE_OFFSET, value);
		return this;
	}
	
	
	@AutoGenerated
	public static final class Array extends VkStructArray<VkAccelerationStructureGeometryLinearSweptSpheresDataNV> {
		
		private static final StructConstructor<VkAccelerationStructureGeometryLinearSweptSpheresDataNV> CONSTRUCTOR = VkAccelerationStructureGeometryLinearSweptSpheresDataNV::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkAccelerationStructureGeometryLinearSweptSpheresDataNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkAccelerationStructureGeometryLinearSweptSpheresDataNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkAccelerationStructureGeometryLinearSweptSpheresDataNV[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
