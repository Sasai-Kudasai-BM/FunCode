...
public final class VkPhysicalDeviceMeshShaderPropertiesNV extends CStruct {
	...
	public VkPhysicalDeviceMeshShaderPropertiesNV sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000202001);
		return this;
	}
	...
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceMeshShaderPropertiesNV maxTaskWorkGroupSize(int[] value) {
	...
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceMeshShaderPropertiesNV maxMeshWorkGroupSize(int[] value) {
