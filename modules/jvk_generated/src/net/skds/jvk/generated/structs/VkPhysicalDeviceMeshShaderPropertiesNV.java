...
public final class VkPhysicalDeviceMeshShaderPropertiesNV extends CStruct {
	...
	public int maxTaskWorkGroupSize(int i) {
		return (int) INT_HANDLE.get(this.segment, this.offset + MAX_TASK_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i);
	}
	
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceMeshShaderPropertiesNV maxTaskWorkGroupSize(int i, int value) {
		INT_HANDLE.set(this.segment, this.offset + MAX_TASK_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i, value);
		return this;
	}
	...
	public int maxMeshWorkGroupSize(int i) {
		return (int) INT_HANDLE.get(this.segment, this.offset + MAX_MESH_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i);
	}
	
	@NativeType("uint32_t[3]")
	public VkPhysicalDeviceMeshShaderPropertiesNV maxMeshWorkGroupSize(int i, int value) {
		INT_HANDLE.set(this.segment, this.offset + MAX_MESH_WORK_GROUP_SIZE_OFFSET + ValueLayout.JAVA_INT.byteSize() * i, value);
		return this;
	}
