...
public final class VkMappedMemoryRange extends CStruct {
	...
	public VkMappedMemoryRange(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkMappedMemoryRange(MemorySegment segment, long offset) {
	...
	public VkMappedMemoryRange sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 6);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkMappedMemoryRange> {
		
		private static final StructConstructor<VkMappedMemoryRange> CONSTRUCTOR = VkMappedMemoryRange::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkMappedMemoryRange[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkMappedMemoryRange[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkMappedMemoryRange[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
