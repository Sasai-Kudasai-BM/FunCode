...
public final class VkPhysicalDeviceVulkan11Properties extends CStruct {
	...
	public VkPhysicalDeviceVulkan11Properties sType$Default() {
		INT_HANDLE.get(this.segment, this.offset + S_TYPE_OFFSET, 50);
		return this;
	}
	...
	@NativeType("VkBool32")
	public VkPhysicalDeviceVulkan11Properties deviceLUIDValid(int value) {
	...
	public int subgroupQuadOperationsInAllStages() {
		return (int) INT_HANDLE.get(this.segment, this.offset + SUBGROUP_QUAD_OPERATIONS_IN_ALL_STAGES_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceVulkan11Properties subgroupQuadOperationsInAllStages(int value) {
		INT_HANDLE.set(this.segment, this.offset + SUBGROUP_QUAD_OPERATIONS_IN_ALL_STAGES_OFFSET, value);
		return this;
	}
	...
	public int protectedNoFault() {
		return (int) INT_HANDLE.get(this.segment, this.offset + PROTECTED_NO_FAULT_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceVulkan11Properties protectedNoFault(int value) {
		INT_HANDLE.set(this.segment, this.offset + PROTECTED_NO_FAULT_OFFSET, value);
		return this;
	}
