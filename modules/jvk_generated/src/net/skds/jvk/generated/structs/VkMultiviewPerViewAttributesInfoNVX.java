...
public final class VkMultiviewPerViewAttributesInfoNVX extends CStruct {
	...
	public VkMultiviewPerViewAttributesInfoNVX sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000044009);
		return this;
	}
	...
	@NativeType("VkBool32")
	public boolean perViewAttributes() {
		return (int) INT_HANDLE.get(this.segment, this.offset + PER_VIEW_ATTRIBUTES_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkMultiviewPerViewAttributesInfoNVX perViewAttributes(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + PER_VIEW_ATTRIBUTES_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
	
	@NativeType("VkBool32")
	public boolean perViewAttributesPositionXOnly() {
		return (int) INT_HANDLE.get(this.segment, this.offset + PER_VIEW_ATTRIBUTES_POSITION_XONLY_OFFSET) != 0;
	}
	
	@NativeType("VkBool32")
	public VkMultiviewPerViewAttributesInfoNVX perViewAttributesPositionXOnly(boolean value) {
		INT_HANDLE.set(this.segment, this.offset + PER_VIEW_ATTRIBUTES_POSITION_XONLY_OFFSET, value ? (int) 1 : (int) 0);
		return this;
	}
