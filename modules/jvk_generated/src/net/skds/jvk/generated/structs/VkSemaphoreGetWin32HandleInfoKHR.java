...
public final class VkSemaphoreGetWin32HandleInfoKHR extends CStruct {
	...
	public VkSemaphoreGetWin32HandleInfoKHR(Arena arena) {
		this.segment = arena.allocate(MEMORY_LAYOUT.byteSize());
	}
	
	public VkSemaphoreGetWin32HandleInfoKHR(MemorySegment segment, long offset) {
	...
	/** values = VK_STRUCTURE_TYPE_SEMAPHORE_GET_WIN32_HANDLE_INFO_KHR **/
	@NativeType("VkStructureType")
	public VkSemaphoreGetWin32HandleInfoKHR sType$Default() {
		INT_HANDLE.set(this.segment, this.offset + S_TYPE_OFFSET, 1000078003);
		return this;
	}
	...
	@AutoGenerated
	public static final class Array extends VkStructArray<VkSemaphoreGetWin32HandleInfoKHR> {
		
		private static final StructConstructor<VkSemaphoreGetWin32HandleInfoKHR> CONSTRUCTOR = VkSemaphoreGetWin32HandleInfoKHR::new;
		
		public Array(int size) {
			super(Arena.ofAuto(), new VkSemaphoreGetWin32HandleInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(Arena arena, int size) {
			super(arena, new VkSemaphoreGetWin32HandleInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
		
		public Array(MemorySegment segment, long offset, int size) {
			super(segment, offset, new VkSemaphoreGetWin32HandleInfoKHR[size], CONSTRUCTOR, MEMORY_LAYOUT);
		}
