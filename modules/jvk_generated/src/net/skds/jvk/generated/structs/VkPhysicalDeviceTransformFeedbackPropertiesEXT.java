...
public final class VkPhysicalDeviceTransformFeedbackPropertiesEXT extends CStruct {
	...
	public int transformFeedbackQueries() {
		return (int) INT_HANDLE.get(this.segment, this.offset + TRANSFORM_FEEDBACK_QUERIES_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceTransformFeedbackPropertiesEXT transformFeedbackQueries(int value) {
		INT_HANDLE.set(this.segment, this.offset + TRANSFORM_FEEDBACK_QUERIES_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int transformFeedbackStreamsLinesTriangles() {
		return (int) INT_HANDLE.get(this.segment, this.offset + TRANSFORM_FEEDBACK_STREAMS_LINES_TRIANGLES_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceTransformFeedbackPropertiesEXT transformFeedbackStreamsLinesTriangles(int value) {
		INT_HANDLE.set(this.segment, this.offset + TRANSFORM_FEEDBACK_STREAMS_LINES_TRIANGLES_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int transformFeedbackRasterizationStreamSelect() {
		return (int) INT_HANDLE.get(this.segment, this.offset + TRANSFORM_FEEDBACK_RASTERIZATION_STREAM_SELECT_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceTransformFeedbackPropertiesEXT transformFeedbackRasterizationStreamSelect(int value) {
		INT_HANDLE.set(this.segment, this.offset + TRANSFORM_FEEDBACK_RASTERIZATION_STREAM_SELECT_OFFSET, value);
		return this;
	}
	
	@NativeType("VkBool32")
	public int transformFeedbackDraw() {
		return (int) INT_HANDLE.get(this.segment, this.offset + TRANSFORM_FEEDBACK_DRAW_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkPhysicalDeviceTransformFeedbackPropertiesEXT transformFeedbackDraw(int value) {
		INT_HANDLE.set(this.segment, this.offset + TRANSFORM_FEEDBACK_DRAW_OFFSET, value);
		return this;
	}
