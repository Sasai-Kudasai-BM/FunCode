...
public final class VkPhysicalDeviceProperties extends CStruct {
	...
	public byte deviceName(int i) {
		return (byte) BYTE_HANDLE.get(this.segment, this.offset + DEVICE_NAME_OFFSET + ValueLayout.JAVA_BYTE.byteSize() * i);
	}
	
	@NativeType("char[256]")
	public VkPhysicalDeviceProperties deviceName(int i, byte value) {
		BYTE_HANDLE.set(this.segment, this.offset + DEVICE_NAME_OFFSET + ValueLayout.JAVA_BYTE.byteSize() * i, value);
		return this;
	}
	
	@NativeType("uint8_t[16]")
	public byte pipelineCacheUUID(int i) {
		return (byte) BYTE_HANDLE.get(this.segment, this.offset + PIPELINE_CACHE_UUID_OFFSET + ValueLayout.JAVA_BYTE.byteSize() * i);
	}
	
	@NativeType("uint8_t[16]")
	public VkPhysicalDeviceProperties pipelineCacheUUID(int i, byte value) {
		BYTE_HANDLE.set(this.segment, this.offset + PIPELINE_CACHE_UUID_OFFSET + ValueLayout.JAVA_BYTE.byteSize() * i, value);
		return this;
	}
