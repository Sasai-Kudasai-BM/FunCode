...
public final class VkIndirectCommandsLayoutTokenNV extends CStruct {
	...
	public int vertexDynamicStride() {
		return (int) INT_HANDLE.get(this.segment, this.offset + VERTEX_DYNAMIC_STRIDE_OFFSET);
	}
	
	@NativeType("VkBool32")
	public VkIndirectCommandsLayoutTokenNV vertexDynamicStride(int value) {
		INT_HANDLE.set(this.segment, this.offset + VERTEX_DYNAMIC_STRIDE_OFFSET, value);
		return this;
	}
