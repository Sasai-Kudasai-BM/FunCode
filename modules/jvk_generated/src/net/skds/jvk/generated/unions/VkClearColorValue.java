...
public final class VkClearColorValue extends CStruct {
	...
	public float[] asFloatArray() {
		...
		MemorySegment.copy(this.segment, FLOAT, this.offset, array, 0, array.length);
		return array;
	}
	...
	@NativeType("float[4]")
	public VkClearColorValue asFloat(float[] value) {
		MemorySegment.copy(value, 0, this.segment, FLOAT, this.offset, value.length);
		return this;
	}
	...
	public int[] asIntArray() {
		var array = new int[4];
		MemorySegment.copy(this.segment, INT, this.offset, array, 0, array.length);
		return array;
	}
	...
	@NativeType("int32_t[4]")
	public VkClearColorValue asInt(int[] value) {
		MemorySegment.copy(value, 0, this.segment, INT, this.offset, value.length);
		return this;
	}
