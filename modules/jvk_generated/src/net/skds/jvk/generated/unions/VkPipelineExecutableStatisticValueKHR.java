...
public final class VkPipelineExecutableStatisticValueKHR extends CStruct {
	...
	public boolean asInt() {
		return (int) INT_HANDLE.get(this.segment, this.offset) != 0;
	}
	
	@NativeType("VkBool32")
	public VkPipelineExecutableStatisticValueKHR asInt(boolean value) {
		INT_HANDLE.set(this.segment, this.offset, value ? (int) 1 : (int) 0);
		return this;
	}
